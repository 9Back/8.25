...
In order to measure peak bandwidth across the loopback, we instantated a TCP server and client and sent 256*(1 << 20) bytes over the wire, and measured how long it took. We then used this to measure the throughput in Mb/s over 1000 trials.
...
\begin{figure}
    ...
    \begin{tabular}{l r r}
      ...
      Prediction & $1Gb/s$ \\
                   & Average & Std Dev.\\
      Actual Timing & 758.71 Mb/s & 13.219 Mb/s \\
\end{tabular}
