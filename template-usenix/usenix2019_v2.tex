...
5 cycles. Adding software uncertainties, the loop overhead could be 50 cycles.
[https://www.7-cpu.com/cpu/SandyBridge.html]
...
\begin{figure}
	\centering
    \begin{tabular}{lll}
      & Reading (cycles) & Loop (cycles) \\
Hardware Guess  & 100 nsec &  5\\
Software Multiplier & 10-30 & 10 \\
Prediction & 1-3 usec & 50\\
Average  & 2.080 usec & 43 \\
Std Dev. & 0.006 usec & 0
\end{tabular}
